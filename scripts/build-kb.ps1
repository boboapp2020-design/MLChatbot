...
$SupportMap  = @(
  ...
  # Codex GHP ฉบับเต็ม — เป็นมาตรฐานที่โรงงานได้รับรองอยู่จริง
  # (LRQA ตรวจในชื่อ "GHP/HACCP Codex 2022")
  # ลิขสิทธิ์ CC BY-NC-SA 3.0 IGO เผยแพร่ต่อได้เพื่อการไม่แสวงหากำไร ต้องอ้างอิงแหล่งที่มา
  # จึงใส่คำอ้างอิงที่ FAO กำหนดไว้ในชื่อเอกสาร เพื่อให้เครดิตติดไปกับทุกคำตอบที่อ้างถึง
  @{ File='Codex-GHP-CXC1-1969-2022-หลักการทั่วไปสุขลักษณะอาหาร.txt'
  ...
  @{ File='สถิติการผลิตรายฤดู 12 ฤดู (Daily Report 2014-2026).txt'
     ...
     Code='ML-SEASON' }
  @{ File='สถิติการหยุดหีบ รายฤดู.txt'
     Module='factory'; Type='RECORD'; Plain=$true; Force=$true; KeepAll=$true
     Title='สถิติการหยุดหีบ รายฤดู (ชั่วโมงหยุดแยกประเภท + Pareto แผนกที่เป็นต้นเหตุ)'
     Code='ML-STOPTIME' }
  # แยกออกมาเป็นของห้องโรงไฟฟ้า เพราะเป็นข้อมูลหม้อไอน้ำและไฟฟ้าของโรงงานโดยตรง
  # เดิมรวมอยู่กับสถิติหยุดหีบและถูกจัดเข้าห้องโรงงานทั้งก้อน
  # ทำให้คำถาม "หม้อไอน้ำมีกี่ลูก" ในห้องโรงไฟฟ้าไปได้ตำราแทนข้อมูลจริง
  @{ File='สถิติหม้อไอน้ำและระบบไฟฟ้า รายฤดู.txt'
     Module='powerplant'; Type='RECORD'; Plain=$true; Force=$true; KeepAll=$true
     Title='สถิติหม้อไอน้ำและระบบผลิตไฟฟ้า รายฤดู (Boiler No.1-3 · ไอน้ำต่อชานอ้อย · ความชื้นเชื้อเพลิง · ไฟฟ้าที่ผลิตและขาย EDL · ค่าควบคุมคุณภาพน้ำ)'
     Code='ML-BOILER-ST' }
  ...
  # ── เอกสารงานทรัพยากรบุคคล ──────────────────────────────────────
  # Force เข้าห้อง hr ทุกฉบับ เพราะเนื้อหาเต็มไปด้วยคำของสถานีผลิต
  # (หม้อเคี่ยว หม้อปั่น โรงงาน ผู้รับเหมา) ถ้าปล่อยให้ keyword ตัดสินจะไหลไปห้องโรงงาน/ความปลอดภัย
  # แล้วห้องทรัพยากรบุคคลจะยังว่างเหมือนเดิม (เดิมมีแค่ 72 ท่อน)
  @{ File='ML-ระเบียบภายในบริษัท ฉบับปี 2026 (ກົດລະບຽບພາຍໃນ).txt'; Module='hr'; Type='STANDARD'; Plain=$true; Force=$true
     Title='กฎระเบียบภายในบริษัท น้ำตาลมิตรลาว ฉบับปี 2026 (เวลาทำงาน กะ ค่าแรง OT วันลา สวัสดิการ สัญญาจ้าง ข้อห้าม)'; Code='ML-RULE26' }
  @{ File='ML-QP-1100-001 การสรรหาว่าจ้างและการพัฒนาบุคลากร Rev.05.txt'; Module='hr'; Type='MANUAL'; Plain=$true; Force=$true
     Title='ML-QP-1100-001 การสรรหาว่าจ้าง และการพัฒนาบุคลากร Rev.05 (13/02/2023)'; Code='ML-HR-QP' }
  @{ File='ML-SP-1100-002 การตรวจสุขภาพพนักงานที่เกี่ยวข้องกับผลิตภัณฑ์ขั้นสุดท้าย.txt'; Module='hr'; Type='MANUAL'; Plain=$true; Force=$true
     Title='ML-SP-1100-002 การตรวจติดตามและเฝ้าระวังสุขภาพอนามัยพนักงานที่เกี่ยวข้องกับผลิตภัณฑ์ขั้นสุดท้าย'; Code='ML-HR-MED' }
  @{ File='ML-SP-1100-003 มาตรฐานความปลอดภัยผู้เยี่ยมชม ผู้มาติดต่องาน และผู้รับเหมา.txt'; Module='hr'; Type='STANDARD'; Plain=$true; Force=$true
     Title='ML-SP-1100-003 มาตรฐานความปลอดภัยเกี่ยวกับผู้เยี่ยมชม ผู้มาติดต่องาน และผู้รับเหมา'; Code='ML-HR-CTR' }
  @{ File='กฎหมายและระเบียบแรงงาน สปป.ลาว ที่โรงงานต้องปฏิบัติ.txt'; Module='hr'; Type='STANDARD'; Plain=$true; Force=$true
     Title='กฎหมายและระเบียบแรงงาน สปป.ลาว (กฎหมายแรงงาน 43/สพช, ประกันสังคม 54/สพช, ดำรัส OSH 22/ລບ, แรงงานต่างประเทศ 0600, แรงงานไวหนุ่ม 4677)'; Code='LAO-LABOUR' }
  # ตัวบทเต็ม 182 มาตรา ฉบับแปลอังกฤษของ ILO NATLEX
  # ต้นฉบับภาษาลาวที่โรงงานเก็บไว้เป็นภาพสแกน JPEG 2000 สกัดข้อความไม่ได้ จึงใช้ฉบับนี้แทน
  @{ File='กฎหมายแรงงานลาว 43-NA 2013 ตัวบทเต็ม (ILO English).txt'; Module='hr'; Type='STANDARD'; Plain=$true; Force=$true
     Title='กฎหมายว่าด้วยแรงงาน สปป.ลาว เลขที่ 43/สพช (2013) — ตัวบทเต็ม 182 มาตรา ฉบับแปลอังกฤษของ ILO NATLEX'; Code='LAO-LAW43' }
  @{ File='SMETA v7 ข้อกำหนดการตรวจประเมินจริยธรรมแรงงาน.txt'; Module='hr'; Type='STANDARD'; Plain=$true; Force=$true
     Title='SMETA version 7 — ข้อกำหนดการตรวจประเมินจริยธรรมทางการค้า (ETI Code & Sedex) ฉบับแปลไทย'; Code='SMETA-V7' }
